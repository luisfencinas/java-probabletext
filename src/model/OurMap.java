 ...
 * 
 * 1) put<K,V> 2) size 3) get<K> 4) boolean containsKey(K)
 * 
 * @author Rick Mercer
 *
 * @param <K> The key for each mapping, which should be Integer or String.
 * @param <V> The value V that gets mapped to key.
 */
